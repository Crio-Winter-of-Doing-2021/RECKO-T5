...
const EntryCard: React.FC<EntryCardProps> = ({provider, accountName, accountId, amount, date, type}) => {
  return (
    <Box className="entry-card" width="100%" backgroundColor="#F7FAFC" color="#2D3748" bgGradient="linear(to-r, #F7FAFC,##F5F7FA)" padding="10px" d="flex" alignItems="baseline" justifyContent="space-evenly">
